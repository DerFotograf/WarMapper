...
os.system(f'title WarMapper V1.2 / By Fotograf.')
time.sleep(1)
...
ipadrr = input(f"{Fore.RED}>> {Fore.BLUE}Introduce la IP a escanear:{Fore.WHITE} ")
port = int(input(f"{Fore.RED}>> {Fore.BLUE}Introduce el puerto que quieras escanear:{Fore.WHITE} "))
